...
//static memory::func<rage::fiDevice*, const char*, bool> GetDeviceHook("41 57 41 56 41 55 41 54 56 57 55 53 48 81 EC 88 05 00 00");
//
...
// Removed until patterns are fixed
